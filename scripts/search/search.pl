...
$basedir = '/usr/local/plesk/apache/vhosts/acidlife.com/httpdocs/';
$baseurl = 'http://www.acidlife.com/';
@files = ('*.html','*.htm');
$title = "Go Home Page";
$title_url = 'http://www.acidlife.com';
$search_url = 'http://www.acidlife.com/search/search.html';
